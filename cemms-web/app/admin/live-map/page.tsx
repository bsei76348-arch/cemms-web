...
export default function LiveMapPage() {
  ...
  const [showNumbersAlways, setShowNumbersAlways] = useState(false); // toggle state
      ...
      <div className="main-content">
        ...
        <div className="header-card">
          <div>
            ...
            <p>Real-time carbon emissions per barangay – Municipality of Marilao</p>
          </div>
        ...
        <div className="map-wrapper">
                ...
                return (
                  ...
                  >
                    <div className="marker-content">
                      ...
                      {showNumbersAlways ? (
                        /* Always show mode: show emission + level pill */
                        ...
                        /* Hover mode: details only on hover */
          ...
          <div className="legend-panel">
            ...
            <div className="watermark">🗺️ MENRO Marilao · Real-time Carbon Map</div>
          </div>
        </div>
      </div>
